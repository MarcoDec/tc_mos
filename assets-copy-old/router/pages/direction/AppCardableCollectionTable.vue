...
<template>
    <AppCol class="d-flex justify-content-between mb-2">
        ...
        <AppBtn variant="success" @click="ajoute">
            <Fa icon="plus"/>
            Ajouter
        </AppBtn>
    </AppCol>
    <AppRow>
        ...
        <AppCol v-if="AddForm && !updated" class="col-7">
            <AppCard class="bg-blue col" title="">
                ...
                <br/>
                <AppForm id="addSociety" :fields="fields" :model-value="formData" label-cols/>
        ...
        <AppCol v-else-if="AddForm && updated" class="col-7">
            <AppCard class="bg-blue col" title="">
                ...
                <br/>
                <AppForm id="updateSociety" :fields="fields" :model-value="formData"/>
                <AppCol class="btnright">
                    <AppBtn class="btnleft" variant="success" size="sm">
