...
class LabelCartonManager
{
    ...
    public function generateETI9ZPLstr(Carton $carton): string {
        return '^XA
            ...
            ^FO420,50^ADR,50,20^FD'.$carton->getCustomerAddressName().'^FS
            ^FO520,1100^ADR,30,20^FDEXPEDITEUR:^FS
            ^FO420,1250^ADR,50,20^FD'.$carton->getManufacturer().'^FS
            ^FO350,50^ADR,30,20^FDDESIGNATION:^FS
            ^FO300,50^ADR,30,20^FD'.$carton->getProductDescription().'^FS
            ^FO260,50^ADR,30,20^FDRef Client:^FS
            ^FO260,320^ADR,30,20^FD'.$carton->getProductReference().'^FS
            ^FO220,50^ADR,30,20^FDIndice:^FS
            ^FO220,220^ADR,30,20^FD'.$carton->getProductIndice().'^FS
            ^FO350,1100^ADR,30,20^FDLOT:^FS
            ^FO240,1250^ADR,80,40^FD'.$carton->getBatchnumber().'^FS
            ^FO40,65^BY3
            ^BCR,50,N,N,N
            ^FD'.$carton->getProductReference().'/'.$carton->getProductIndice().'/'.$carton->getBatchnumber().'^FS
            ^FO160,50^ADR,30,20^FDREFERENCE PRODUIT:^FS
            ^FO90,120^ADR,60,40^FD'.$carton->getProductReference().'/'.$carton->getProductIndice().'^FS
            ^FO160,1100^ADR,30,20^FDQUANTITE:^FS
            ^FO40,1300^ADR,100,60^FD'.$carton->getQuantity().'^FS
            ^XZ';
    }
