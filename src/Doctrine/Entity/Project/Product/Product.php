...
use App\Doctrine\Entity\Embeddable\Project\Product\CurrentPlace;
use App\Doctrine\Entity\Entity;
use App\Doctrine\Entity\Interfaces\BarCodeInterface;
use App\Doctrine\Entity\Interfaces\MeasuredInterface;
use App\Doctrine\Entity\Logistics\Incoterms;
use App\Doctrine\Entity\Management\Unit;
use App\Doctrine\Entity\Traits\BarCodeTrait;
use App\Doctrine\Entity\Traits\NameTrait;
use App\Doctrine\Entity\Traits\RefTrait;
use App\Doctrine\Entity\Traits\WorkflowTrait;
...
class Product extends Entity implements BarCodeInterface, MeasuredInterface {
    ...
    #[
        ...
        Assert\Choice(choices: self::PRODUCT_KINDS, groups: ['Product-admin', 'Product-create', 'Product-project']),
    ...
    #[
        ...
        Assert\Length(max: 255, groups: ['Product-create', 'Product-production']),
        ORM\Column(nullable: true),
        Serializer\Groups(['create:product', 'read:product', 'write:product:production'])
    ]
