...
class Product extends EntityId implements BarCodeInterface, MeasuredInterface {
    ...
    #[
        ...
        Serializer\Groups(['create:product', 'read:product', 'read:product:collection', 'read:stock', 'read:stock:grouped', 'write:product', 'write:product:admin', 'write:product:clone'])
    ]
