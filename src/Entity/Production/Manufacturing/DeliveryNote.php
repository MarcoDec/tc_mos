...
#[
    ApiFilter(filterClass: OrderFilter::class, properties: ['date' => 'DESC', 'ref' => 'DESC', 'embState.state' => 'DESC']),
    ApiFilter(filterClass: RelationFilter::class, properties: ['date', 'ref']),
