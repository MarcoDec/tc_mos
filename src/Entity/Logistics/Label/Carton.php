...
class Carton extends Entity  implements MeasuredInterface, FileEntity
{
    ...
    public function generateTConceptZPLstr(): string {
        return '^XA
...
^FO580,50^ADR,50,20^FD'.$this->customerAddressName.'^FS
^FO710,850^ADR,30,20^FDEXPEDITEUR:^FS
^FO580,880^ADR,50,20^FD'.$this->manufacturer.'^FS
^FO480,50^ADR,30,20^FDDESIGNATION:^FS
^FO400,50^ADR,30,20^FD'.$this->productDescription.'^FS
^FO350,50^ADR,30,20^FDRef Client:^FS
^FO350,320^ADR,30,20^FD'.$this->productReference.'^FS
^FO300,50^ADR,30,20^FDIndice:^FS
^FO300,220^ADR,30,20^FD'.$this->productIndice.'^FS
^FO480,850^ADR,30,20^FDLOT:^FS
^FO300,880^ADR,80,40^FD'.$this->batchnumber.'^FS
^FO50,65^BY3
^BCR,100,N,N,N
^FD'.$this->productReference.'/'.$this->productIndice.'/'.$this->batchnumber.'^FS
^FO230,50^ADR,30,20^FDREFERENCE PRODUIT:^FS
^FO155,120^ADR,60,40^FD'.$this->productReference.'/'.$this->productIndice.'^FS
^FO230,850^ADR,30,20^FDQUANTITE:^FS
^FO60,920^ADR,100,60^FD'.$this->quantity.'^FS
^XZ';
    }
}