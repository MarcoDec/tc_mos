...
use App\Doctrine\DBAL\Types\Purchase\Order\Item\CurrentPlaceType;
...
class CurrentPlace extends AbstractCurrentPlace {
    ...
    #[
        ...
        Assert\NotBlank,
        ORM\Column(type: 'supplier_order_item_current_place', options: ['default' => CurrentPlaceType::TYPE_DRAFT]),
