...
use App\Doctrine\DBAL\Types\Production\Manufacturing\Operation\CurrentPlaceType;
...
class CurrentPlace extends AbstractCurrentPlace {
    final public const TRANSITIONS = [self::TR_ACCEPT, self::TR_BLOCK, self::TR_SUPERVISE, self::TR_VALIDATE];
    ...
    #[
        ...
        Assert\NotBlank,
        ORM\Column(type: 'manufacturing_operation_current_place', options: ['default' => CurrentPlaceType::TYPE_DRAFT]),
