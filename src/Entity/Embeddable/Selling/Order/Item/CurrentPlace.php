...
use App\Doctrine\DBAL\Types\Selling\Order\Item\CurrentPlaceType;
...
class CurrentPlace extends AbstractCurrentPlace {
    ...
    #[
        ...
        Assert\NotBlank,
        ORM\Column(type: 'customer_order_item_current_place', options: ['default' => CurrentPlaceType::TYPE_DRAFT]),
