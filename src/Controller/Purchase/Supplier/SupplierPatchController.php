...
namespace App\Controller\Purchase\Supplier;
...
class SupplierPatchController
{
   public function __construct(private readonly EntityManagerInterface $em, private SupplierRepository $repository, private LoggerInterface $logger) {
   }
    ...
    */
   public function __invoke(Request $request): Supplier {
