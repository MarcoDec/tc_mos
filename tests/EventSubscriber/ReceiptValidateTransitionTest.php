...
class ReceiptValidateTransitionTest extends KernelTestCase
{
    ...
    public function testApplyValidateTransitionToWorkflow(): void {
        echo "\nReceiptValidateTransitionTest::testApplyValidateTransitionToWorkflow()\n";
...
//        print_r($receipt1);
        ...
        $this->assertEquals('partially_received', $receipt2->getItem()->getState(), 'L\'item de commande du receipt2 devrait être dans l\'état partially_received');
    }
