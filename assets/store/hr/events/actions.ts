...
export const actions = {
    async [ActionTypes.FETCH_EVENTS](): Promise<void> {
        const response: Events[] = [
            ...
            {date: '2022-01-04', name: 'Event 6', id: 6, relationId: '1',relation: 'employees', type: 'y','@type': 'b'},
            ...
            {date: '2021-09-19', name: 'Event 10', id: 10, relationId: '3',relation: 'employees', type: 'z','@type': 'c'},
            {date: '2021-08-18', name: 'Event 11', id: 11, relationId: '3',relation: 'employees', type: 'z','@type': 'c'}
        ]
