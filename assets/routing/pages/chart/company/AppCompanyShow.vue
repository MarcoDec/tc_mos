...
<template>
  <div class="text-center bg-secondary text-white">
    <b>Nombre de personnes qui travaillent par mois</b>
  </div>
  <AppRow>
    <vue3-chart-js
      :id="livChart.id"
  ...
  <div class="text-center bg-secondary text-white">
    <b>Graphique du chiffre d'affaire</b>
  </div>
  ...
  <div class="text-center bg-secondary text-white">
    <b>Nombre d'heures travaillées par mois</b>
  </div>
  ...
  <AppRow>
    ...
    <AppChartTable
      :data="heureChart.data"
      :titleX="heureChart.options.scales.x.title.text"
      :titleY="heureChart.options.scales.y.title.text"
    />
  </AppRow>
</template>
