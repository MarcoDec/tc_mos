...
var reference = ["111111", "2555555", "322222", "100025555"];
const getRefProduct = (nb: number) => {
  let ret = [];
    ...
    <div class="container bcontent">
      ...
      <div class="card" v-for="list in displayed" :key="list">
        <div class="row no-gutters">
          ...
          <div class="col-sm-7">
            <div class="card-body">
              <h5 class="card-title">{{ list.ref }}</h5>
              <table
                class="table table-hover table-striped table-responsive table-sm table-bordered"
              >
                <thead>
                  <tr>
                    <th>Product Ref</th>
              ...
              <h5 class="card-title">Dates stock épuisés</h5>
              <table
                class="table table-hover table-striped table-responsive table-sm table-bordered"
              >
                <thead>
