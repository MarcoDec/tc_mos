<script setup>
    ...
    const baseRoles = [
        ...
        'ROLE_PURCHASE_WRITER', 'ROLE_PURCHASE_ADMIN',
        'ROLE_QUALITY_READER', 'ROLE_QUALITY_WRITER', 'ROLE_QUALITY_ADMIN',
        'ROLE_SELLING_READER', 'ROLE_SELLING_WRITER', 'ROLE_SELLING_ADMIN'
    ]
