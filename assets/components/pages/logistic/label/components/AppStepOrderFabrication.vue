<script setup>
    ...
    const ofField = ref('')
    const productToPut = ref('<à définir>')
...
<template>
    <div>
        <div class="step-title">Entrer l'Ordre de Fabrication</div>
        <div class="d-flex flex-row align-items-center justify-content-end">
            <div class="d-flex flex-column">
                <div class="d-flex flex-row align-items-center justify-content-end">
                    <label for="of" class="labelOfProduct"><strong>OF</strong></label>
                    <input id="of" ref="inputOfRef" v-model="ofField" class="form-control inputOfProduct" type="text"/>
                </div>
            </div>
            <button class="btn btn-success m-2" @click="validate()" style="height: 80%;">
