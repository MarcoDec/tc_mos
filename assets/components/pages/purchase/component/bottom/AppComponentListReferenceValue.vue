<script setup>
    ...
    import {useComponentListReferenceValueStore} from '../../../../../stores/component/componentListReferenceValue'
    ...
    async function cancelSearch() {
        filter.value = true
        storeComponentListReferenceValue.fetch()
    }
</script>
        ...
        <AppRow>
            ...
            <!-- <AppCol v-if="AddForm && !updated" class="col-7">
                <AppCard class="bg-blue col" title="">
                    ...
                    <br/>
                    <AppFormCardable id="addComponentReferenceValue" :fields="fieldsForm" :model-value="formData" label-cols/>
                    ...
                    <AppCol class="btnright">
                        <AppBtn class="btn-float-right" label="Ajout" variant="success" size="sm" @click="ajoutComponentReferenceValue">
