<script setup>
    ...
    import {useComponentListStockStore} from '../../../../../stores/component/componentListStock'
    ...
    const parentVolumeAnnuel = {
        ...
        $id: 'componentStockVolumeAnnuel'
    }
    const storeUnitStockVolumeAnnuel = useField(fieldsForm[2], parentVolumeAnnuel)
    await storeUnitStockVolumeAnnuel.fetch()

    fieldsForm[2].measure.code = storeUnitStockVolumeAnnuel.measure.code
    fieldsForm[2].measure.value = storeUnitStockVolumeAnnuel.measure.value

    fieldsForm[6].measure.code = storeUnitStockVolumeAnnuel.measure.code
    fieldsForm[6].measure.value = storeUnitStockVolumeAnnuel.measure.value
    ...
    const tabFields = [
        ...
        },
        {
            ...
            sort: true,
            measure: {
                value: storeUnitStockVolumeAnnuel.measure.value,
                code: storeUnitStockVolumeAnnuel.measure.code
            },
            type: 'measure',
            update: true
        },
