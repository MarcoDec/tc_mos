                    ...
                    table: {
                        ...
                        body: [
                            [{text: '#', style: 'tableHeader'},
                             ...
                             {text: 'Prix U HT', style: 'tableHeader'},
                            ...
                            [
                                ...
                                {text: 'TN', style: 'tableBody'},
                                {text: '234 Kg', style: 'tableBody'},
                                {text: '1.73823€', style: 'tableBody'},
                                {text: '1200', style: 'tableBody', color: '#0d6efd'},
                                {text: '2085.87€', style: 'tableBody'}
                            ],
                            [
                                ...
                                {text: '1.95303€', style: 'tableBody'},
                                {text: '400', style: 'tableBody', color: '#0d6efd'},
                                {text: '783.61€', style: 'tableBody'}
                            ],
                            [
                                {colSpan: '9', text: '', margin: [0, 5, 0, 5]},
                                '',
                                '',
                                '',
                                '',
