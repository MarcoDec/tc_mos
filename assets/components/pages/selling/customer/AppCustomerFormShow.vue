<script setup>
    import AppShowCustomerTabAccounting from './AppShowCustomerTabAccounting.vue'
    import AppShowCustomerTabAddress from './AppShowCustomerTabAddress.vue'
    import AppShowCustomerTabContact from './AppShowCustomerTabContact.vue'
