...
<template>
    <div>
        <AppTabs id="tabs-ws-inlist" class="gui-start-content">
            <AppTab id="gui-start-maintenances" active icon="paint-roller" title="Types de maintenances" tabs="tabs-ws-inlist">
