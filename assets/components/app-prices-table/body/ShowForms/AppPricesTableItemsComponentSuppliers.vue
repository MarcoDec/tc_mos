            ...
            <div v-if="field.name !== 'prices'">
                <div v-if="field.type === 'select'">
                    <template v-if="isObject(item[field.name])">
                        <span
                            v-if="field.options.label(item[field.name]['@id']) !== null">
                            {{ field.options.label(item[field.name]['@id']) }}
                        </span>
                        <span v-else>
                            {{ item[field.name] }}
                        </span>
                    ...
                    <template v-else>
                        <span
                            v-if="field.options.label(item[field.name]) !== null">
                ...
                <div v-else-if="field.type === 'measure'">
                    <div v-if="field.measure.code.type === 'select'" class="text-center">
                        ...
                        <span
                            v-if="field.measure.code.options.label(item[field.name].code) !== null">
                            {{ field.measure.code.options.label(item[field.name].code) }}
                        </span>
                        <span v-else>
                ...
                <div v-else-if="field.type === 'link'">
                    <a
                        v-if="item[field.name] !== null && item[field.name] !== ''"
                ...
                <div v-else>
                    <span
                        v-if="isObject(item[field.name])"
                        class="bg-danger text-white">
                        Object given for field '{{ field.name }}' - {{ item[field.name] }}
                    </span>
                    <span v-else>
                        {{ item[field.name] }}
                    </span>
