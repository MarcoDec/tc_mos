<script setup>
    ...
    import {useCustomerListOFStore} from './storeProvisoir/customerListOF'
    ...
    const formData = ref({
        ...
        dernierOf: null, derniereFacture: null, prix: null, quantite: null
    })
    ...
    const storeUnitQtyOF = useField(fieldsForm[8], parentQuantityOF)
    storeUnitQtyOF.fetch()

    fieldsForm[8].measure.code = storeUnitQtyOF.measure.code
    fieldsForm[8].measure.value = storeUnitQtyOF.measure.value
    ...
    function update(item) {
        ...
        const itemsData = {
            ...
            derniereFacture: item.derniereFacture,
            prix: item.prix,
    ...
    async function search(inputValues) {
        ...
        const payload = {
            ...
            derniereFacture: inputValues.derniereFacture ?? '',
