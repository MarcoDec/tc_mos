<script setup>
    ...
    const fieldsHistoriqueMaintenances = [
        {
            create: false,
            filter: true,
    ...
    const fieldsPiecesRechange = [
        ...
        },
        {
            create: false,
            filter: true,
            label: 'Sous Famille de Composant',
            name: 'sousFamilleComposant',
            sort: false,
            type: 'text',
            update: true
        },
