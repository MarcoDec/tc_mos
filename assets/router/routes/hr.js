    ...
    },
    {
        ...
        props: {
            fields: [
                ...
                {label: 'Début', name: 'start', search: true, sort: true, type: 'time', update: true},
                {label: 'Début pause', name: 'startBreak', search: true, sort: true, type: 'time', update: true},
                {label: 'Fin pause', name: 'endBreak', search: true, sort: true, type: 'time', update: true},
                {label: 'Fin', name: 'end', search: true, sort: true, type: 'time', update: true}
            ],
            icon: 'clock',
