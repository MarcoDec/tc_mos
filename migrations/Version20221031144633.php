...
final class Version20221031144633 extends AbstractMigration {
...
SQL,
    ...
    private function getPhoneQueries(): string {
        return $this->phoneQueries->implode('; ');
    }

    private function getQueries(): string {
        return $this->queries->implode('; ');
    }
...
CREATE TABLE `bill_item` (
    ...
    `price_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `weight_code`VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `weight_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
CREATE TABLE `bill` (
    ...
    `emb_blocker_state` ENUM('blocked', 'disabled', 'enabled', 'under_waiver') DEFAULT 'enabled' NOT NULL COMMENT '(DC2Type:blocker_state)',
    `emb_state_state` ENUM('billed', 'draft', 'partially_paid', 'paid') DEFAULT 'draft' NOT NULL COMMENT '(DC2Type:bill_state)',
    `excl_tax_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `excl_tax_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `incl_tax_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `incl_tax_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `incl_tax_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `notes` TEXT DEFAULT NULL,
    `ref` VARCHAR(255) DEFAULT NULL,
    `vat_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `vat_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
CREATE TABLE `component_attribute` (
    ...
    `measure_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `measure_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
CREATE TABLE `component_reference_value` (
    ...
    `height_tolerance_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `height_tolerance_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `height_tolerance_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `height_value_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `height_value_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `height_value_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `section_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `section_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `section_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `tensile_required` BOOLEAN DEFAULT TRUE NOT NULL,
    `tensile_tolerance_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `tensile_tolerance_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `tensile_tolerance_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `tensile_value_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `tensile_value_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `tensile_value_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `width_required` BOOLEAN DEFAULT TRUE NOT NULL,
    `width_tolerance_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `width_tolerance_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `width_tolerance_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `width_value_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `width_value_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
CREATE TABLE `component` (
    ...
    `old_id` INT UNSIGNED NOT NULL,
    `deleted` BOOLEAN DEFAULT FALSE NOT NULL,
    `copper_weight_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `copper_weight_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `forecast_volume_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `min_stock_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `min_stock_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
SQL);
        $currencies = Collection::collect(Currencies::getCurrencyCodes())
...
CREATE TABLE `manufacturing_operation` (
    `id` INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
    `deleted` BOOLEAN DEFAULT FALSE NOT NULL,
    `actual_quantity_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `emb_blocker_state` ENUM('blocked', 'closed', 'enabled', 'under_waiver') DEFAULT 'enabled' NOT NULL COMMENT '(DC2Type:closer_state)',
    ...
    `quantity_produced_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `quantity_produced_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
CREATE TABLE `product` (
    ...
    `id_society` INT UNSIGNED NOT NULL,
    `deleted` BOOLEAN DEFAULT FALSE NOT NULL,
    `auto_duration_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `auto_duration_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `auto_duration_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `code` VARCHAR(50) NOT NULL,
    `costing_auto_duration_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `costing_auto_duration_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `costing_auto_duration_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `costing_manual_duration_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `costing_manual_duration_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `manual_duration_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `manual_duration_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `manual_duration_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `max_proto_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `max_proto_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `max_proto_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `min_delivery_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `min_delivery_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `min_delivery_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `min_prod_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `min_prod_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `notes` text DEFAULT NULL,
    `packaging_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `packaging_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `price_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `price_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `price_without_copper_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `price_without_copper_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `price_without_copper_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `production_delay_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `production_delay_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `production_delay_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `transfert_price_supplies_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `transfert_price_supplies_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `transfert_price_supplies_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `transfert_price_work_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `transfert_price_work_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
CREATE TABLE `project_operation` (
    ...
    `cadence_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `cadence_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `price_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `price_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `time_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `time_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
CREATE TABLE `purchase_order_item` (
    ...
    `confirmed_quantity_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `confirmed_quantity_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `confirmed_quantity_value` DOUBLE PRECISION DEFAULT 0 NOT NULL,
    `copper_price_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `requested_quantity_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `requested_quantity_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
CREATE TABLE `society` (
    ...
    `copper_index_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `copper_index_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `incoterms_id` INT UNSIGNED DEFAULT NULL,
    `invoice_min_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `invoice_min_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `name` VARCHAR(255) DEFAULT NULL,
    `notes` TEXT DEFAULT NULL,
    `order_min_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `order_min_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
CREATE TABLE `customer` (
    ...
    `address_phone_number` VARCHAR(255) DEFAULT NULL,
    `address_zip_code` VARCHAR(10) DEFAULT NULL,
    `conveyance_duration_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `conveyance_duration_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `monthly_outstanding_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `monthly_outstanding_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    ...
    `notes` TEXT DEFAULT NULL,
    `outstanding_max_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `outstanding_max_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
CREATE TABLE `supplier_component` (
    ...
    `copper_weight_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `copper_weight_value` DOUBLE PRECISION DEFAULT '0' NOT NULL,
    `delivery_time_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `delivery_time_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `delivery_time_value` DOUBLE PRECISION DEFAULT '0' NOT NULL,
    `incoterms_id` INT UNSIGNED DEFAULT NULL,
    `index` VARCHAR(255) DEFAULT '0' NOT NULL,
    `moq_code` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
    `moq_denominator` VARCHAR(6) DEFAULT NULL COLLATE `utf8mb3_bin`,
...
ALTER TABLE `unit`
    ...
    CHANGE `unit_short_lbl` `code` VARCHAR(6) NOT NULL COLLATE `utf8mb3_bin`,
