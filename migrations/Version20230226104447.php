...
final class Version20230226104447 extends AbstractMigration
{
   ...
   private static function trim(string $str): string {
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE parameter (id INT UNSIGNED AUTO_INCREMENT NOT NULL, link INT UNSIGNED DEFAULT NULL, deleted TINYINT(1) DEFAULT 0 NOT NULL, name VARCHAR(255) NOT NULL, target VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, type ENUM(\'ARRAY\', \'SELECT_MULTIPLE_LINK\', \'INTEGER\') NOT NULL, value VARCHAR(255) NOT NULL, process VARCHAR(255) NOT NULL, INDEX IDX_2A97911036AC99F1 (link), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
   ...
   private function generateParameter(Parameter $parameter, string $process): void {
      ...
      $this->addQuery(sprintf(
         <<<SQL
INSERT INTO `parameter` (`deleted`, `name`, `target`, `type`, `value`, `process`, `description` )
