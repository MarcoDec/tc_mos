 ...
 */
final class Version20230925175340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nomenclature DROP FOREIGN KEY IDX_799A36524584665A');
        $this->addSql('ALTER TABLE nomenclature ADD sub_product_id INT UNSIGNED NOT NULL');
        $this->addSql('ALTER TABLE nomenclature ADD CONSTRAINT FK_799A36524584665A FOREIGN KEY (product_id) REFERENCES product_customer (id)');
        $this->addSql('ALTER TABLE nomenclature ADD CONSTRAINT FK_799A3652694FF597 FOREIGN KEY (sub_product_id) REFERENCES product_customer (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nomenclature DROP FOREIGN KEY FK_799A36524584665A');
        ...
        $this->addSql('ALTER TABLE nomenclature DROP sub_product_id');
        $this->addSql('ALTER TABLE nomenclature ADD CONSTRAINT IDX_799A36524584665A FOREIGN KEY (product_id) REFERENCES product (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
