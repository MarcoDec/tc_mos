...
/**
 * @phpstan-type OpenApiProperty array{'$ref': string}|array{default?: mixed, enum?: string[], example?: mixed, externalDocs?: array{url: string}, format?: string, maxLength?: int, minLength?: int, nullable: bool, oneOf?: array<mixed|SchemaContext>, readOnly: bool, type?: string}
